...
(function(window, $, Agave, undefined){
  ...
  function showToken() {
    $('.current-token').html('<p>Value: <span class="label label-success">'+ Agave.token.access_token +'</span> Expires: ' + new Date(Agave.token.created + (1000 * Agave.token.expires_in)).toLocaleString() + '</p>');
